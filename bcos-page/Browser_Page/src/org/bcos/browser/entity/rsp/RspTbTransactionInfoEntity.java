...
public class RspTbTransactionInfoEntity implements Serializable {
	...
	public String toString() {
		...
		sb.append("\"pkHash\":\"").append(pkHash).append('\"');
		sb.append(",\"blockHash\":\"").append(blockHash).append('\"');
		sb.append(",\"blockNumber\":").append(blockNumber);
		sb.append(",\"blockTimesStr\":\"").append(blockTimesStr).append('\"');
		sb.append(",\"blockGasLimit\":").append(blockGasLimit);
		...
		sb.append(",\"cumulativeGas\":").append(cumulativeGas);
		sb.append(",\"randomId\":\"").append(randomId).append('\"');
